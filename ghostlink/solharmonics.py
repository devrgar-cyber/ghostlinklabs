...
# Mapping of keywords to Sol Harmonics packs
PACK_KEYWORDS: Dict[str, List[str]] = {
    "SLEEP": ["sleep", "tired", "2am", "insomnia"],
    "FOCUS": ["focus", "scroll", "can't think"],
    "CALM": ["anxious", "panic", "overwhelm"],
    "MOMENTUM": ["stuck", "procrastinate", "can't start"],
    "RELEASE": ["angry", "resentment", "conflict"],
    "STABILITY": ["money", "spend", "stress bills"],
}

# Moves corresponding to each pack
MOVES: Dict[str, str] = {
    "SLEEP": "kill screens for 30 minutes. dark room. breathe 4-7-8 x 8.",
    "FOCUS": "set a 15-minute timer. one task. no tabs. start now.",
    "CALM": "feet on floor. inhale 4, hold 4, exhale 8, x10. then text one sentence of truth.",
    "MOMENTUM": "ship the ugly first version to one person before midnight.",
    "RELEASE": "write the unsent message in notes. do not send.",
    "STABILITY": "cancel one non-essential charge today. screenshot = done.",
